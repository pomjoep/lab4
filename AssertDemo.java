...
public class AssertDemo {
    ...
    private static void assertWithObjects() {
        ...
        AssertDemo assertDemo1 = new AssertDemo();
        assert (assertDemo1.equals(ad));
        assert (assertDemo1.equals(assertDemo1));
    }
    ...
    private static void homeworkRelatedAsserts() {
        ...
        Object newDate = new Object();;
        assert (newDate != null);

        int quarters = 25;
        assert(quarters >= 0 && quarters <=100);
