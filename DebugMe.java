...
public class DebugMe{
    public static void main(String[]args){
        ...
        System.out.println("Enter an int to see the sums of all numbers between 1 and the number entered, \nEnter in the format: DebugMe {num}");
        printSums(scanner.nextLine());
        compareBoxes();
    }
    ...
    public static void printSums(String num){
